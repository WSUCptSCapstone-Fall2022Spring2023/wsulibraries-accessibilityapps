...
export declare namespace CommonDataTypes {
    ...
    const ListLocalValueSchema: zod.ZodArray<zod.ZodUnion<[zod.ZodObject<{
        ...
        handle: string;
    }>, zod.ZodType<any, zod.ZodTypeDef, any>]>, "many">;
...
export declare namespace Session {
    ...
    const SubscribeParametersSchema: zod.ZodObject<{
        events: zod.ZodArray<zod.ZodEnum<[BrowsingContext.EventNames.ContextCreatedEvent, BrowsingContext.EventNames.ContextDestroyedEvent, BrowsingContext.EventNames.DomContentLoadedEvent, BrowsingContext.EventNames.LoadEvent, Log.EventNames.LogEntryAddedEvent, CDP.EventNames.EventReceivedEvent]>, "many">;
        contexts: zod.ZodOptional<zod.ZodArray<zod.ZodString, "many">>;
    }, "strip", zod.ZodTypeAny, {
        contexts?: string[] | undefined;
        events: (BrowsingContext.EventNames | Log.EventNames.LogEntryAddedEvent | CDP.EventNames.EventReceivedEvent)[];
    }, {
        contexts?: string[] | undefined;
        events: (BrowsingContext.EventNames | Log.EventNames.LogEntryAddedEvent | CDP.EventNames.EventReceivedEvent)[];
    }>;
