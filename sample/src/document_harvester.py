...
INPUT_DIRECTORY = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "\\..\\data\\input"

# This path is where we can create or update our transformed PDF.
OUTPUT_DIRECTORY = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "\\..\\data\\output"
