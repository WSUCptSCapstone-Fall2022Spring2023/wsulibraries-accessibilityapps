...
export declare class BrowsingContextImpl {
    #private;
    private constructor();
    static createFrameContext(contextId: string, parentId: string | null, cdpClient: CdpClient, cdpSessionId: string, eventManager: IEventManager): Promise<void>;
    static createTargetContext(contextId: string, parentId: string | null, cdpClient: CdpClient, cdpSessionId: string, cdpBrowserContextId: string | null, eventManager: IEventManager): Promise<void>;
